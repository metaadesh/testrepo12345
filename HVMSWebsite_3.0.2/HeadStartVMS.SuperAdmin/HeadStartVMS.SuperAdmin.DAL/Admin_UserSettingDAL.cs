...
{
    public class Admin_UserSettingDAL
    {
        ...
        public void LogMailContent(String Subject, String Body, int EmailType, String MailTo, String MailFrom, String MailCCed, String MailBCCed, DataTable dtRefID)
        {
            ...
            Admin_DALDataContext DC = new Admin_DALDataContext();
        ...
        public bool CheckUserNameExistance(String UserName)
        {
            bool isExist = false;
            Admin_DALDataContext obj = new Admin_DALDataContext();
            ISingleResult<Admin_CheckUserNameExistanceResult> result;
            result = objDAL.Admin_CheckUserNameExistance(UserName);
            isExist = (bool)result.SingleOrDefault().Column1.Value;
            return isExist;
        }

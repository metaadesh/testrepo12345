...
namespace METAOPTION.DAL
{
    public class Admin_BuyerDAL
    {
        ...
        public long AddBuyerDetails(Buyer objBuyer, Address objAddress)
        {
            ...
            Admin_DALDataContext.Factory.DB.BuyerDetailsInsert(ref BuyerId, objBuyer.TitleId, objBuyer.FirstName, objBuyer.MiddleName,
        ...
        //{
        //    IQueryable result = Admin_DALDataContext.Factory.DB.GetBuyers().AsQueryable();
        //    return result;
        //}
        //#endregion
        ...
        {
            return Admin_DALDataContext.Factory.DB.BuyerListSearch(buyerName, commissionId, paymentId, city, countryId, stateId, zip, Status, OrgID).AsEnumerable();
        }
        #endregion
        ...
        //{
        //    IQueryable result = Admin_DALDataContext.Factory.DB.GetBuyerDetailsByBuyerId(BuyerId, OrgID).AsQueryable();
        //    return result;
        //}
        //#endregion
        ...
        //{
        //    return METAOPTION.Admin_DALDataContext.Factory.DB.GetPurchasedCarsByBuyer(BuyerId, StartRowIndex, MaximumRows).AsEnumerable();
        //}
        //#endregion
        ...
        //{
        //    GetPurchasedCarsByBuyerCountResult result = METAOPTION.Admin_DALDataContext.Factory.DB.GetPurchasedCarsByBuyerCount(BuyerId, StartRowIndex, MaximumRows).Single();
        ...
        //{
        //    int result = METAOPTION.Admin_DALDataContext.Factory.DB.BuyerDetailsUpdate(objBuyer.BuyerId, objBuyer.TitleId, objBuyer.FirstName,
        ...
        //    return result = METAOPTION.Admin_DALDataContext.Factory.DB.GetBuyerCommCalculationInfo(buyerId, expenseId).SingleOrDefault();
        //}
        ...
        //{
        //    int recordCount = METAOPTION.Admin_DALDataContext.Factory.DB.GetBuyerOutstandings(buyerId).Count();
        //    if (recordCount > 0)
        //        return METAOPTION.Admin_DALDataContext.Factory.DB.GetBuyerOutstandings(buyerId).SingleOrDefault().TotalOutstandingAmount.Value;
        //    else
        //        return 0;
        //}
        //#endregion
        ...
        //{
        //    GetBuyerOutstandingsDetailsResult[] result = METAOPTION.Admin_DALDataContext.Factory.DB.GetBuyerOutstandingsDetails(buyerId).ToArray();
        //    return result;
        //}
        //#endregion
        ...
        //{
        //    GetBuyerCommissionSettingsResult result = METAOPTION.Admin_DALDataContext.Factory.DB.GetBuyerCommissionSettings(buyerId).SingleOrDefault();
        //    return result;
        //}
        //#endregion
        ...
        //{
        //    GetBuyerCommSettings_FromTranTableResult result = METAOPTION.Admin_DALDataContext.Factory.DB.GetBuyerCommSettings_FromTranTable(buyerCommissionId).SingleOrDefault();
        //    return result;
        //}
        //#endregion
        ...
        {
            int recordCount = Admin_DALDataContext.Factory.DB.BuyerCode_CheckAvailability(BuyerCode).SingleOrDefault().Total.Value;
            if (recordCount > 0)
                return 1;
            else
                return 0;
        ...
        //{
        //    int i = METAOPTION.Admin_DALDataContext.Factory.DB.DeleteArchiveBuyer(Status, BuyerID, UserID);
        //}
        //#endregion
        ...
        {
            IQueryable result = Admin_DALDataContext.Factory.DB.Buyer_DirectBuyerList(orgID).AsQueryable();
            return result;
        }
        #endregion
        ...
        //{
        //    Admin_DALDataContext dal = new Admin_DALDataContext();
        ...
        //{
        //    BuyerCommissionSettings_FetchResult result = METAOPTION.Admin_DALDataContext.Factory.DB.BuyerCommissionSettings_Fetch(buyerId).SingleOrDefault();
        //    return result;
        //}
        //#endregion
    }

...
namespace METAOPTION.DAL
{
    public class Admin_Common
    {
        ...
        // static Admin_DALDataContext objDALStatic = new Admin_DALDataContext();
        ...
        //{
        //    return METAOPTION.Admin_DALDataContext.Factory.DB.GetYear().ToList<GetYearResult>();
        //}
        ...
        //{
        //    return METAOPTION.Admin_DALDataContext.Factory.DB.GetMake(year).AsQueryable();
        //}
        //public static List<YMM_CommonRecordsResult> YMM_CommonRecords()
        //{
        //    return METAOPTION.Admin_DALDataContext.Factory.DB.YMM_CommonRecords().ToList<YMM_CommonRecordsResult>();
        //}
        //#endregion
        ...
        //{
        //    return METAOPTION.Admin_DALDataContext.Factory.DB.GetModel(makeId).AsQueryable();
        //}
        //#endregion
        ...
        //{
        //    return METAOPTION.Admin_DALDataContext.Factory.DB.GetBody(modelId).AsQueryable();
        //}
        //#endregion
        ...
        //{
        //    return METAOPTION.Admin_DALDataContext.Factory.DB.GetExteriorColorsForMMBY(year, makeId, modelId, bodyId).ToList();
        //}
        //#endregion
        ...
        //{
        //    List<GetEnginesResult> result = METAOPTION.Admin_DALDataContext.Factory.DB.GetEngines().ToList<GetEnginesResult>();
        //    return result;
        //}
        //#endregion
        ...
        //{
        //    List<GetTransResult> result = METAOPTION.Admin_DALDataContext.Factory.DB.GetTrans().ToList<GetTransResult>();
        //    return result;
        //}
        //#endregion
        ...
        //{
        //    return METAOPTION.Admin_DALDataContext.Factory.DB.GetWheelDrives().AsQueryable();
        //}
        //#endregion
        ...
        //{
        //    List<GetDesignationResult> result = METAOPTION.Admin_DALDataContext.Factory.DB.GetDesignation().ToList<GetDesignationResult>();
        //    return result;
        //}
        //#endregion
        ...
        //{
        //    List<GetBuyerListResult> result = METAOPTION.Admin_DALDataContext.Factory.DB.GetBuyerList(OrgID).ToList<GetBuyerListResult>();
        //    return result;
        //}
        //#endregion
        ...
        //{
        //    GetBuyerListNewResult[] result = METAOPTION.Admin_DALDataContext.Factory.DB.GetBuyerListNew().ToArray();
        //    return result;
        //}
        //#endregion
        ...
        //{
        //    return METAOPTION.Admin_DALDataContext.Factory.DB.GetCommonExtColors().ToList();
        //}
        //#endregion
        ...
        //{
        //    return METAOPTION.Admin_DALDataContext.Factory.DB.GetCommonIntColors().ToList();
        //}
        //#endregion
        ...
        {
            IQueryable<EmployeeType> result = (from p in objDAL.EmployeeTypes
                                               where p.IsActive == 1
                                               orderby p.EmployeeType1
                                               select p) as IQueryable<EmployeeType>;
            return result;
        }
        #endregion
        ...
        {
            IQueryable result = METAOPTION.Admin_DALDataContext.Factory.DB.GetTitles().AsQueryable();
            return result;
        }
        ...
        //{
        //    IQueryable result = METAOPTION.Admin_DALDataContext.Factory.DB.GetEmployeeType().AsQueryable();
        //    return result;
        //}
        //#endregion
        ...
        {
            return METAOPTION.Admin_DALDataContext.Factory.DB.GetCountryList().ToList<GetCountryListResult>();
        }
        #endregion
        ...
        {
            IQueryable result = METAOPTION.Admin_DALDataContext.Factory.DB.GetStates(CountryId).AsQueryable();
            return result;
        }
        #endregion
        ...
        //{
        //    return METAOPTION.Admin_DALDataContext.Factory.DB.GetPaymentFrequency().AsQueryable();
        //}
        //#endregion
        ...
        //{
        //    List<GetDealerListResult> result = METAOPTION.Admin_DALDataContext.Factory.DB.GetDealerList().ToList<GetDealerListResult>();
        //    return result;
        //}
        //#endregion
       //public class org
       ...
       // }
        #region[Modify datatable and add Organization name on basis of OrgID]
        public static DataTable modifydatatable(DataTable dt)
        {
            Admin_DALDataContext objDAL = new Admin_DALDataContext();
            ...
            SqlCommand cmd = new SqlCommand("SELECT * FROM Organisation",con);
            ...
            int cout=0;
            while(cout < newtab.Columns.Count)
            {
                newtab.Columns[cout].ColumnName = newtab.Columns[cout].ColumnName.ToString().ToLower();
                cout++;
            }
      ...
      #region[Adding Organization Value to table By comparison]
            ...
            {
                k = 0;
                while (k < newtab.Rows.Count) 
                {

                    if (string.IsNullOrEmpty(dt.Rows[j]["orgid"].ToString()))
                    {
                        dt.Rows[j]["organization"] = null;
                    }
                    else
                    {
                        if ((Convert.ToInt16(dt.Rows[j]["orgid"].ToString()) == Convert.ToInt16(newtab.Rows[k]["orgid"].ToString())))
                        {

                            dt.Rows[j]["organization"] = newtab.Rows[k]["organisation"].ToString();
                        }
                    }
        ...
        public static System.Data.DataTable LookupTableRecords(String sqlStatement)
        {
            ...
            using (System.Data.SqlClient.SqlConnection con = new System.Data.SqlClient.SqlConnection())
            {
                ...
                int count = dtab.Columns.Count;
                while (count > 0)
                {
                    if (dtab.Columns[count - 1].ColumnName == "orgid")
                    {
                        DataTable dtable = new DataTable();
                        dr.Close();
                        con.Dispose();
                        return (dtable = modifydatatable(dtab));
                    }
                    else
                    {
                        count--;
        ...
        public Int32 newAddBankAccount(int BankID, string AccNumber, Int16 OrgID, Int64 AddedBy, int isActive, String MODE)
        {
            Admin_DALDataContext objdal = new Admin_DALDataContext();
        ...
        #region[Count all entity type in repeter control at Master left pannel]
        public DataTable GetEmpCount(Int16 ORGID)
        {
            ...
            SqlCommand cmd = new SqlCommand("Organisation_CountAllEmployees", con);
        ...
        {
            Admin_DALDataContext obj = new Admin_DALDataContext();
            return obj.SelectAllLookupTables(IsReadWrite).AsQueryable();
        }
        #endregion

        #region[Get all organisation List]
        public IQueryable OrganizationList()
        {
            Admin_DALDataContext objorg = new Admin_DALDataContext();

            IQueryable organisation_name = (from org in objorg.Organisations
                                            where org.IsActive == 1
                                            select new { org.OrgID, org.Organisation1 }).AsQueryable();
        ...
        #region[Get all Organisation datatable ]
            public DataTable GetOrganizations( string MODE)
        {
            Admin_DALDataContext objorg = new Admin_DALDataContext();
            //Table<Organisation> mt = objorg.GetTable<Organisation>();
            //var str = from m in mt.AsEnumerable()
            //          orderby m.Organisation1 ascending
            //          select new { key = m.OrgID, value = m.Organisation1,code=m.OrgCode};
            //DataTable dt = new DataTable();
            //dt.Columns.Add("OrgID", typeof(Int16));
            //dt.Columns.Add("Organisation",typeof(string));
            //dt.Columns.Add("DisplayName",typeof(string));
            //string CreateDisplay;
            //foreach (var i in str)
            //{
            //     CreateDisplay = i.value +" ("+ i.code+")";
            //    dt.Rows.Add(i.key,i.value,CreateDisplay);
            //}
            SqlConnection con = new SqlConnection(objorg.Connection.ConnectionString);
            SqlCommand cmd = new SqlCommand("Admin_GetAllEntitiesCount", con);
            if (con.State == ConnectionState.Closed)
            {
                con.Open();
            }
        ...
        //{
        //    spSystemStatsResult result = Admin_DALDataContext.Factory.DB.spSystemStats(SystemID, OrgID).FirstOrDefault();
        ...
        //{
        //    GetMobileActivityCurrentDetailsResult result = Admin_DALDataContext.Factory.DB.GetMobileActivityCurrentDetails(OrgID).FirstOrDefault();
        //    return result;
        //}
        ...
        //{
        //    GetMobileActivityCurrentDetails_Ver211Result result = Admin_DALDataContext.Factory.DB.GetMobileActivityCurrentDetails_Ver211(EntityTypeID, SecurityUserID).FirstOrDefault();
        //    return result;
        //}
        ...
        //{
        //    GetMobileActivityCurrentDetails_Ver211_NewResult result = Admin_DALDataContext.Factory.DB.GetMobileActivityCurrentDetails_Ver211_New(EntityTypeID, IsDirectBuyer, ParentBuyerId, BuyerAccessLevel, EntityId).FirstOrDefault();
        //    return result;
        //}
        //#endregion
        ...
        //{
        //    return Admin_DALDataContext.Factory.DB.Lane_Static(LaneType, OrgID).ToList<Lane_StaticResult>();
        //}
        //#endregion
        ...
        //{
        //    return METAOPTION.Admin_DALDataContext.Factory.DB.ChromeUpdatesSelect().AsEnumerable();
        //}
        //#endregion
        ...
        //{
        //    return METAOPTION.Admin_DALDataContext.Factory.DB.LogErrors(strErrorMessage);
        //}
        //#endregion
        ...
        //{
        //    return METAOPTION.Admin_DALDataContext.Factory.DB.GetLiveUsers(topCount, OrgID);
        //}
        //#endregion
        ...
        //{
        //    return METAOPTION.Admin_DALDataContext.Factory.DB.GetInventoryLifeCycleInfo(MasterId);
        //}
        ...
        //{
        //    int? entityCount = 0;
        //    METAOPTION.Admin_DALDataContext.Factory.DB.CanEntityBeDeleted(entityId, entityTypeId, ref entityCount);
        ...
        //{
        //    return METAOPTION.Admin_DALDataContext.Factory.DB.Delete_Entity(entityId, entityTypeId, deletedby, deleteddate);
        //}
        ...
        //{
        //    long? makeID = 0;
        //    METAOPTION.Admin_DALDataContext.Factory.DB.CHROME_YMMB_MAKE_LOG_Insert(make, ref makeID, year, addedBy, addedDate);
        ...
        //{
        //    long? modelId = 0;
        //    METAOPTION.Admin_DALDataContext.Factory.DB.CHROME_YMMB_MODEL_LOG_Insert(model, makeId, ref modelId, year, addedBy, addedDate);
        ...
        //{
        //    long? bodyId = 0;
        //    METAOPTION.Admin_DALDataContext.Factory.DB.CHROME_YMMB_BODY_LOG_Insert(body, modelId, ref bodyId, year, addedBy, addedDate);
        ...
        //{
        //    return METAOPTION.Admin_DALDataContext.Factory.DB.GETCUSTOMMAKE(year).ToArray();
        //}
        //public GETCUSTOMMODELResult[] GetCustomModel(long makeId)
        //{
        //    return METAOPTION.Admin_DALDataContext.Factory.DB.GETCUSTOMMODEL(makeId).ToArray();

        //}
        //public GETCUSTOMBODYResult[] GetCustomBody(long modelId)
        //{
        //    return METAOPTION.Admin_DALDataContext.Factory.DB.GETCUSTOMBODY(modelId).ToArray();
        //}
        //#endregion
        ...
        //{
        //    return METAOPTION.Admin_DALDataContext.Factory.DB.CHROME_YMMB_MAKE_LOG_Update(year, makeId, make, ModifiedBy, isActive);
        //}

        //public int UpdateCustomModel(long modelId, long makeId, string model, long ModifiedBy, int isActive)
        //{
        //    return METAOPTION.Admin_DALDataContext.Factory.DB.CHROME_YMMB_MODEL_LOG_Update(makeId, modelId, model, ModifiedBy, isActive);
        //}

        //public int UpdateCustomBody(long bodyId, long modelId, string body, long ModifiedBy, int isActive)
        //{
        //    return METAOPTION.Admin_DALDataContext.Factory.DB.CHROME_YMMB_BODY_LOG_Update(modelId, bodyId, body, ModifiedBy, isActive);
        //}
        ...
        //{
        //    int TransactionId = METAOPTION.Admin_DALDataContext.Factory.DB.CHROME_YMMB_SYNCHRONIZATION(scheduledBy);
        ...
        //{
        //    int count = METAOPTION.Admin_DALDataContext.Factory.DB.IsCustomMake(MakeId).Single().Count.GetValueOrDefault();
        //    if (count > 0)
        //        return true;
        //    else return false;
        ...
        //{
        //    int count = METAOPTION.Admin_DALDataContext.Factory.DB.IsCustomModel(ModelId).Single().Count.GetValueOrDefault();
        //    if (count > 0)
        //        return true;
        //    else return false;
        //}
        ...
        //{
        //    int count = METAOPTION.Admin_DALDataContext.Factory.DB.IsCustomBody(BodyId).Single().Count.GetValueOrDefault();
        //    if (count > 0)
        //        return true;
        //    else return false;
        //}
        ...
        //{
        //    return METAOPTION.Admin_DALDataContext.Factory.DB.GetYear().Take(count).ToArray();
        //}
        ...
        //{
        //    return METAOPTION.Admin_DALDataContext.Factory.DB.CHROME_YMMB_MAKE_LOG_Delete(makeId, deletedBy);
        //}
        //public int DeleteCustomModel(long modelId, long deletedBy)
        //{
        //    return METAOPTION.Admin_DALDataContext.Factory.DB.CHROME_YMMB_MODEL_LOG_Delete(modelId, deletedBy);
        //}
        //public int DeleteCustomBody(long bodyId, long deletedBy)
        //{
        //    return METAOPTION.Admin_DALDataContext.Factory.DB.CHROME_YMMB_BODY_LOG_Delete(bodyId, deletedBy);
        //}
        ...
        //{
        //    return METAOPTION.Admin_DALDataContext.Factory.DB.CHROME_YMMB_GetMakes().AsQueryable();
        //}
        ...
        //{
        //    return METAOPTION.Admin_DALDataContext.Factory.DB.Mobile_Chrome_YMMB_GetMakes().AsQueryable();
        //}
        //#endregion
        ...
        //{
        //    return METAOPTION.Admin_DALDataContext.Factory.DB.Mobile_Chrome_YMMB_GetModels(makeId).AsQueryable();
        //}
        //#endregion
        ...
        //{
        //    return METAOPTION.Admin_DALDataContext.Factory.DB.Mobile_Chrome_YMMB_GetBody(modelId).AsQueryable();
        //}
        //#endregion
        ...
        //{
        //    return METAOPTION.Admin_DALDataContext.Factory.DB.Mobile_GetUsers().AsQueryable();
        //}
        //#endregion
        ...
        //{
        //    IQueryable result = METAOPTION.Admin_DALDataContext.Factory.DB.Mobile_GetBuyerList().AsQueryable();
        //    return result;
        //}
        //#endregion
        ...
        //{
        //    return METAOPTION.Admin_DALDataContext.Factory.DB.GetModel(makeId).ToList<GetModelResult>();
        //}
        ...
        //{
        //    spSystemStats_Ver211Result result = Admin_DALDataContext.Factory.DB.spSystemStats_Ver211(SystemID, EntityiTypeId, SecurityId).FirstOrDefault();
        //    return result;
        //}
        ...
        //{
        //    spSystemStats_Dealer_Ver211Result result = Admin_DALDataContext.Factory.DB.spSystemStats_Dealer_Ver211(SystemID, EntityiTypeId, SecurityId).FirstOrDefault();
        //    return result;
        //}
        //#endregion
        ...
        //{
        //    bool isValid = false;
        //    using (SqlConnection con = new SqlConnection(Admin_DALDataContext.Factory.DB.Connection.ConnectionString))
        //    {
        //        if (con.State == ConnectionState.Closed)
        //        {
        //            con.Open();

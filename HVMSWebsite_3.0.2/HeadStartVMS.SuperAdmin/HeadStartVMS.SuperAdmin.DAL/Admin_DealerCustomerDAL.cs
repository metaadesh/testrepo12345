...
{
    public class Admin_DealerCustomerDAL
    {
        ...
        /// <returns></returns>
        public long AddDealerDetails(Dealer objDealer, Address objAddress)
        {
            Nullable<long> DealerId = null;
            METAOPTION.Admin_DALDataContext.Factory.DB.CustomerDealerInsert(ref DealerId, objDealer.DealerName, objDealer.DealerDIN
        ...
        {
            METAOPTION.Admin_DALDataContext.Factory.DB.DealerFranchiseInsert(FranchiseId, DealerId);
        }
        #endregion
        ...
        //{
        //    METAOPTION.Admin_DALDataContext.Factory.DB.DealerPreferenceInsert(objDealerPreference.DealerId, objDealerPreference.yearsFrom, objDealerPreference.yearsTo,
        ...
        //{
        //    METAOPTION.Admin_DALDataContext.Factory.DB.DealerMobilePreferenceInsert(objDealerMobile.DealerId, objDealerMobile.MobileNo, objDealerMobile.IsEnable, objDealerMobile.AddedBy, Mode);
        //}
        //#endregion
        ...
        //{
        //    METAOPTION.Admin_DALDataContext.Factory.DB.DealerEmailPreferenceInsert(objDealerEmail.DealerId, objDealerEmail.Email, objDealerEmail.IsEnable, objDealerEmail.AddedBy, Mode);
        //}
        //#endregion
        ...
        //    return METAOPTION.Admin_DALDataContext.Factory.DB.GetDealerDetailsByDealerId(DealerId, OrgID).AsQueryable();
        //}
        //#endregion
        ...
        //    var result = METAOPTION.Admin_DALDataContext.Factory.DB.GetDealerFranchise(DealerId);
        ...
        //    METAOPTION.Admin_DALDataContext.Factory.DB.GetMakeName(DealerId, ref strMakeName);
        //    return strMakeName;
        //}
        //#endregion
        ...
        //{
        //    return METAOPTION.Admin_DALDataContext.Factory.DB.GetDealerPreferenceSetting(DealerId).AsQueryable();
        //}
        //#endregion
        ...
        //{
        //    // return METAOPTION.Admin_DALDataContext.Factory.DB.GetDealerMobilePreference(DealerId).AsQueryable();
        ...
        //{
        //    // return METAOPTION.Admin_DALDataContext.Factory.DB.GetDealerEmailPreference(DealerId).AsQueryable();
        ...
        //{
        //    return METAOPTION.Admin_DALDataContext.Factory.DB.GetPurchasedCarsByDealer(DealerId, StartRowIndex, MaximumRows).AsEnumerable();
        //}
        //#endregion
        ...
        //{
        //    GetPurchasedCarsByDealerCountResult result = METAOPTION.Admin_DALDataContext.Factory.DB.GetPurchasedCarsByDealerCount(DealerId, StartRowIndex, MaximumRows).Single();
        ...
        //{
        //    return METAOPTION.Admin_DALDataContext.Factory.DB.GetSoldCarsToDealer(DealerId, StartRowIndex, MaximumRows).AsEnumerable();
        //}
        //#endregion
        ...
        //{
        //    GetSoldCarsToDealerCountResult result = METAOPTION.Admin_DALDataContext.Factory.DB.GetSoldCarsToDealerCount(DealerId, StartRowIndex, MaximumRows).Single();
        //    return result.TotalRecord;
        //}
        //#endregion
        ...
        //{
        //    return METAOPTION.Admin_DALDataContext.Factory.DB.GetDealerBusinessSummary(DealerId).AsQueryable();
        //}
        //#endregion
        ...
        //{
        //    METAOPTION.Admin_DALDataContext.Factory.DB.DealerFranchiseDelete(DealerId);
        //}
        //#endregion

        //#region[Update Dealer/Customer Details]
        //public int UpdateDealerDetails(Dealer objDealer, Address objAddress)
        //{
        //    return METAOPTION.Admin_DALDataContext.Factory.DB.CustomerDealerUpdate(objDealer.DealerId, objDealer.DealerName, objDealer.DealerDIN
        //    , objDealer.DealerTypeId
        //    , objDealer.DealerCategoryId
        //    , objDealer.DealerSourceId
        //    , objDealer.Comment
        ...
        //{
        //    return METAOPTION.Admin_DALDataContext.Factory.DB.DealerPreferenceSettingUpdate(objDealer.PreferenceSettings
        //         , objDealer.ReceiveSms
        //         , objDealer.ReceiveEmail
        //         , objDealer.DealerId);
        //}
        ...
        //{
        //    return METAOPTION.Admin_DALDataContext.Factory.DB.DealerPreferenceUpdate(objDealerPreference.DealerPreferenceId
        ...
        //{
        //    return METAOPTION.Admin_DALDataContext.Factory.DB.DealerMobilePreferenceUpdate(objDealerMobile.DealerMobileId
        ...
        //{
        //    return METAOPTION.Admin_DALDataContext.Factory.DB.DealerEmailPreferenceUpdate(objDealerEmail.DealerEmailId
        ...
        //public DataTable DealerSearchList(String dealerName, Int32 categoryId, Int32 typeId, String city, Int32 countryId, Int32 stateId, String zip, Int32 StartRowIndex, Int32 MaximumRows, String SortExpression, Int32 Status, Int32 OrgID)
        //{
        //    DataTable dt = new DataTable("Dealers");
        //    using (SqlConnection Conn = new SqlConnection(METAOPTION.Admin_DALDataContext.Factory.DB.Connection.ConnectionString))
        //    {
        ...
        //public Int32? DealerSearchListCount(String dealerName, Int32 categoryId, Int32 typeId, String city, Int32 countryId, Int32 stateId, String zip, Int32 StartRowIndex, Int32 MaximumRows, String SortExpression, Int32 Status, Int32 OrgID)
        //{
        //    using (SqlConnection Conn = new SqlConnection(METAOPTION.Admin_DALDataContext.Factory.DB.Connection.ConnectionString))
        //    {
        //        SqlCommand Cmd = Conn.CreateCommand();
        ...
        //    var result = METAOPTION.Admin_DALDataContext.Factory.DB.GetDealerNameById(DealerId).AsQueryable();
        ...
        //{
        //    return METAOPTION.Admin_DALDataContext.Factory.DB.Inventory_Dealer_ByBuyerID(buyerID).ToList<Inventory_Dealer_ByBuyerIDResult>();
        //}
        //#endregion
        ...
        //{
        //    int i = METAOPTION.Admin_DALDataContext.Factory.DB.DeleteArchiveDealer(Status, DealerID, UserID);
        //}
        //#endregion
        ...
        //{
        //    return METAOPTION.Admin_DALDataContext.Factory.DB.Inventory_Customer_ByBuyerID(BuyerID, SoldDateFrom, SoldDateTo).ToList<Inventory_Customer_ByBuyerIDResult>();
        //}
        //#endregion
        ...
        //{
        //    return METAOPTION.Admin_DALDataContext.Factory.DB.InventoryDealer_ByBuyerID(BuyerID, SoldDateFrom, SoldDateTo).ToList<InventoryDealer_ByBuyerIDResult>();
        //}
        //#endregion
    }
}

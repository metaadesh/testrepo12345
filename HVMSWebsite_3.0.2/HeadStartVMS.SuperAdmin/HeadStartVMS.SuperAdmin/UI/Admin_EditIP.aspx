<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin_EditIP.aspx.cs"
    Inherits="METAOPTION.UI.Admin_EditIP" Title="Admin Panel :: Edit IP"  %>
...
<body style="background-color: White;">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function SetIPRestriction(ctrl, ShowHideFlag) {
            ...
            $.ajax({ type: "POST",
                url: "Admin_EditIP.aspx/UpdateAutoIPApproval",

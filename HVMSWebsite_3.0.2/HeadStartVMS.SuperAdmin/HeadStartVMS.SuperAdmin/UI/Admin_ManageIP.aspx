<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin_ManageIP.aspx.cs"
    MasterPageFile="~/UI/Admin_Master.Master" Inherits="METAOPTION.UI.ManageIP" Title="Admin Panel :: Manage IP" %>
    ...
    <div onmousemove="SetProgressPosition(event)">
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                    ...
                    <table width="100%" cellspacing="0" cellpadding="0">
                        <tr>
                            <td class="TableBorder">
                                <asp:Label ID="Label5" runat="server" Text="Organization" CssClass="TableBorderLabel"></asp:Label>
                            </td>
                            <td class="TableBorder">
                            ...
                            <td class="TableBorder">
                                <asp:Label ID="Label1" runat="server" Text="IP Address" CssClass="TableBorderLabel"></asp:Label>
                            </td>
                            <td class="TableBorder">
                                <asp:TextBox ID="txtIP" runat="server" CssClass="txt2" onblur="validate(this);" Width="175px"></asp:TextBox>
                            ...
                            <td class="TableBorder">
                                <asp:Label ID="Label2" runat="server" Text="Description" CssClass="TableBorderLabel"></asp:Label>
                            </td>
                            <td class="TableBorder">
                        ...
                        <tr>
                            ...
                            <td class="TableBorder" colspan="2" align="center">
                                <asp:RadioButtonList ID="rdbIPType" runat="server" CssClass="TableBorderLabel" Width="200px"
                        ...
                        <tr>
                            <td colspan="6" style="text-align: right; padding-left: 20px; padding-top: 5px">
                ...
                <br />
                <div style="clear: both; min-height: 350px; vertical-align: top;">
                    <asp:GridView ID="gvIPPermission" runat="server" AutoGenerateColumns="False" Width="100%"
                        ...
                        <Columns>
                            <asp:BoundField DataField="Organisation" HeaderText="Organization" SortExpression="IPAddress"
                            ...
                            <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="User" ItemStyle-CssClass="GridContent"
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="lblEntityType" runat="server" Width="180px"></asp:Label>
                ...
                <asp:Panel ID="panOpen" runat="server" ScrollBars="Auto" Width="850px" CssClass="ModalWindow"
                    Style="background-color: #FFFFFF; min-height: 300px; max-height: 700px; border: 3px solid Gray;
                    font-family: Verdana; font-size: 10pt">
                    <div style="display: none">
                        <img src="../Images/close_icon.gif" alt="close" id="imgCancel" runat="server" />
                    </div>
                    <iframe id="ifrmEditIP" runat="server" scrolling="auto" style="min-height: 290px;
                        max-height: 670px; width: 850px;" frameborder="0"></iframe>
                </asp:Panel>
                ...
                <asp:Panel ID="pnlAdd" runat="server" ScrollBars="Auto" Height="250px" Width="900px"
                    ...
                    <iframe id="IframeAdd" runat="server" scrolling="auto" style="height: 250px; width: 900px;"

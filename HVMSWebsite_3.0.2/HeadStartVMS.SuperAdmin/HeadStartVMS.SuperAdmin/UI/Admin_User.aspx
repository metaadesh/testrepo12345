<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/UI/Admin_MasterLeftPanel.Master"
    CodeBehind="Admin_User.aspx.cs" Inherits="METAOPTION.UI.Admin_User" Title="Admin Panel :: User" %>
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" ID="cphUser" runat="server">
                                ...
                                <table border="0" class="TableBorder" width="100%" cellpadding="0" style="border-collapse: collapse">
                                    <tr>
                                        ...
                                        <td class="TableBorder">
                                            <asp:DropDownList ID="ddlOrganization" runat="server" Width="180px" AutoPostBack="true"
                                                OnSelectedIndexChanged="ddlOrganization_OnSelectedIndexChanged" CssClass="txtMan2">
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr id="trFullName" runat="server">
                                        ...
                                        <td class="TableBorder">
                                            ...
                                            <asp:LinkButton ID="lnkPopUp" runat="server" CssClass="OrangeText_LeftPanel" OnClick="lnkPopUp_Click">Click to select user</asp:LinkButton>
                                            <asp:LinkButton ID="lnkAddNewUser" runat="server" CssClass="OrangeText_LeftPanel"
                                                Style="margin-left: 10px;" OnClick="lnkAddNewUser_Click">Add new user</asp:LinkButton>
                                    ...
                                    <tr>
                                        ...
                                        <td class="TableBorder">
                                            <asp:TextBox ID="txtUserName" runat="server" Width="175px" CssClass="txtMan2" MaxLength="50"
                                                autocomplete="Off" />
                                            <asp:RequiredFieldValidator ID="rfvTxtUserName" runat="server" ErrorMessage="*" Font-Bold="true"
                                                ValidationGroup="EditUpdateUser" ControlToValidate="txtUserName"></asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    <tr id="trPassword" runat="server">
                                        ...
                                        <td class="TableBorder">
                                            <asp:TextBox ID="txtPassword" runat="server" Width="175px" TextMode="Password" CssClass="txt2"
                                                MaxLength="50" />
                                            <asp:RequiredFieldValidator ID="rfvTxtPassword" runat="server" ErrorMessage="*" Font-Bold="true"
                                                ValidationGroup="EditUpdateUser" ControlToValidate="txtPassword"></asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    <tr id="trCofirmPassword" runat="server">
                                        ...
                                        <td class="TableBorder">
                                            <asp:TextBox ID="txtConpassword" runat="server" Width="175px" TextMode="Password"
                                                CssClass="txt2" MaxLength="50" />
                                            <asp:RequiredFieldValidator ID="rfvTxtConPassword" runat="server" ErrorMessage="*"
                                                ValidationGroup="EditUpdateUser" Font-Bold="true" ControlToValidate="txtConpassword"></asp:RequiredFieldValidator>
                                            <asp:CompareValidator ID="cValidatorPwd" runat="server" ErrorMessage="Password does not match"
                                                ControlToValidate="txtConpassword" ControlToCompare="txtPassword" ValidationGroup="EditUpdateUser"></asp:CompareValidator>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="TableBorderB">
                                        ...
                                        <td class="TableBorder">
                                            <asp:TextBox ID="txtDisplayName" runat="server" Width="175px" CssClass="txt2" MaxLength="50" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="TableBorderB">
                                        ...
                                        <td class="TableBorder">
                                            <asp:TextBox ID="txtNotes" runat="server" Width="175px" TextMode="MultiLine" CssClass="txtMulti"
                                                MaxLength="255" />
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td class="TableBorder" colspan="2" align="center">
                                            ...
                                            <asp:Button ID="btnSubmit" CssClass="btn" Text="Save" runat="server" OnClick="btnSubmit_Click"
                                                ValidationGroup="EditUpdateUser" />
                                ...
                                <table border="0" width="100%" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td class="PopUpBoxHeading" align="right">
                                            <img id="imgCloseEntityList" border="0" src="../Images/close.gif" alt="Close" style="margin-right: 5px" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="lblb">
                                    ...
                                    <tr>
                                        <td>
                                            <asp:GridView ID="GrdGroup" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                GridLines="None" DataKeyNames="SecurityUserGroupId" AllowSorting="true" 
                                                Width="100%" onrowdatabound="GrdGroup_RowDataBound" >
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="GroupName" HeaderText="Group Name" ItemStyle-CssClass="GridContent"
                                                        HeaderStyle-CssClass="GridContent" />
                                                    <asp:BoundField DataField="GroupDesc" HeaderText="Description" ItemStyle-CssClass="GridContent"
                                                        HeaderStyle-CssClass="GridContent" />
                                                </Columns>
                                                <RowStyle CssClass="gvRow" />
                                                <AlternatingRowStyle CssClass="gvAlternateRow" />
                    ...
                    <tr>
                        <td>
                            <fieldset id="fsSettings" runat="server" class="ForFieldSet">
                                ...
                                <div>
                                    <asp:GridView ID="gvUserSettings" runat="server" AutoGenerateColumns="false" GridLines="None"
                                    ...
                                    <asp:GridView ID="gvIpPermission" runat="server" AutoGenerateColumns="false" GridLines="None"
                                        ShowHeader="false" Width="100%" OnRowDataBound="gvIpPermission_RowDataBound">
                                        <Columns>
    ...
    function ChangeSettingkeyValue(KeyValue) {
        ...
        $.ajax({ type: "POST",
            url: "Admin_User.aspx/UpdateUserSetting",
    ...
    function SetIPRestriction(ctrl, ShowHideFlag) {
       var EntityType = "<%= Session["empID"]%>";
        ...
        $.ajax({ type: "POST",
            url: "../UI/Admin_User.aspx/UpdateAutoIPApproval",

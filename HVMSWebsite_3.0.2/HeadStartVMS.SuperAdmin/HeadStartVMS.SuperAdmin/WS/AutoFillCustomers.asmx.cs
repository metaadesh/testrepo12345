...
namespace METAOPTION.WS
{
    ...
    public class AutoFillNames : System.Web.Services.WebService
    {
        ...
        //{
        //    METAOPTION.DALDataContext objDataContext = new METAOPTION.DALDataContext();
        //    DataTable dtUser = METAOPTION.BAL.Admin_MakeUserBAL.GetUserInfo(UserID);
        //    //GetUserInfo
        ...
        public bool BuyerCodeAvailability(String BuyerCode)
        {
            ...
            {
                if (METAOPTION.BAL.Admin_BuyerBAL.BuyerCodeAvailability(BuyerCode.Trim()) > 0)// Check if BuyerCode already exists
                    return false;
                else
                    return true;
            }
        ...
        //    ListOfModels = BAL.Admin_Common.GetListOfModels(MakeID);

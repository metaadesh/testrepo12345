...
{
    public class Admin_DealerCustomerBAL
    {
        ...
        /// <returns></returns>
        /// 
        public static long AddDealerDetails(Dealer objDealer, Address objAddress)
        {
            METAOPTION.DAL.Admin_DealerCustomerDAL objDealerCustomerDAL = new Admin_DealerCustomerDAL();
            HttpContext.Current.Cache.Remove(Admin_CacheEnum.Dealer);
            return objDealerCustomerDAL.AddDealerDetails(objDealer, objAddress);
        }
        #endregion
        ...
        //public static int UpdateDealerDetails(Dealer objDealer, Address objAddress)
        //{
        //    METAOPTION.DAL.Admin_DealerCustomerDAL objDealerCustomerDAL = new Admin_DealerCustomerDAL();
        //    HttpContext.Current.Cache.Remove(Admin_CacheEnum.Dealer);
        //    return objDealerCustomerDAL.UpdateDealerDetails(objDealer, objAddress);
        //}
        //#endregion
        ...
        //{
        //    Admin_DealerCustomerDAL dcDAL = new Admin_DealerCustomerDAL();
        ...
        //{
        //    Admin_DealerCustomerDAL objDealerDAL = new Admin_DealerCustomerDAL();
        ...
        //{
        //    Admin_DealerCustomerDAL objDAL = new Admin_DealerCustomerDAL();

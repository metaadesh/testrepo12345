...
namespace METAOPTION.BAL
{
    public class Admin_MasterBAL
    {
        ...
        Admin_MasterDAL objMasterDAL = new Admin_MasterDAL();
        ...
        {
            //return objMasterDAL.GetCommisionType();
            if (HttpContext.Current.Cache[Admin_CacheEnum.CommissionType] != null)
                return (List<CommissionType>)HttpContext.Current.Cache[Admin_CacheEnum.CommissionType];
            else
            {
                ...
                HttpContext.Current.Cache[Admin_CacheEnum.CommissionType] = des;
                HttpContext.Current.Cache.Insert(Admin_CacheEnum.CommissionType, des, null, System.Web.Caching.Cache.NoAbsoluteExpiration, TimeSpan.FromMinutes(LongCacheExpiry));
        ...
        //public IQueryable DocumentType(long EntityTypeId)
        //{
        //    return objMasterDAL.DocumentType(EntityTypeId);
        //}
        //#endregion
    }
}

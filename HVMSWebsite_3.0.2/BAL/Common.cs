...
namespace METAOPTION.BAL
{
    ...
    public class Common
    {
        ...
        public static List<GetExteriorColorsForMMBYResult> GetExteriorColorForMMBY(int year, long makeId, long modelId, long bodyId)
        {
            ...
            return DAL.Common.GetExteriorColorForMMBY(year, makeId, modelId, bodyId);
        ...
        {
            return DAL.Common.GetInteriorColorForMMBY(year, makeId, modelId, bodyId);
        ...
        {
            //METAOPTION.DAL.Common objCommon = new METAOPTION.DAL.Common();
            return DAL.Common.CommonInteriorColors();
        }
        #endregion
        ...
        {
            return DAL.Common.CommonExteriorColors();
        }
        #endregion
        ...
        //#region [Get List of Years- Static]
        ///// <summary>
        ///// Get list of all years - Static
        ///// </summary>
        ///// <returns>List of Years</returns>
        //public static IQueryable GetYears()
        //{
        //    METAOPTION.DAL.Common objCommon = new METAOPTION.DAL.Common();
        //    return objCommon.GetYearList();
        //}
        ...
        {
            if (HttpContext.Current.Cache[CacheEnum.YMM] == null)
            {
                List<YMM_CommonRecordsResult> result = DAL.Common.YMM_CommonRecords().ToList<YMM_CommonRecordsResult>();
                HttpContext.Current.Cache.Insert(CacheEnum.YMM, result, null, System.Web.Caching.Cache.NoAbsoluteExpiration, TimeSpan.FromMinutes(LongCacheExpiry));
                return result;
            }
            else
                return (List<YMM_CommonRecordsResult>)HttpContext.Current.Cache[CacheEnum.YMM];
        ...
        public List<GetCountryListResult> GetCountryList()
        {
            ...
            if (HttpContext.Current.Cache[CacheEnum.Country] != null)
                return (List<GetCountryListResult>)HttpContext.Current.Cache[CacheEnum.Country];
            else
            {
                METAOPTION.DAL.Common objCommon = new METAOPTION.DAL.Common();
                List<GetCountryListResult> country = objCommon.GetCountryList();
                HttpContext.Current.Cache[CacheEnum.Country] = country;
                HttpContext.Current.Cache.Insert(CacheEnum.Country, country, null, System.Web.Caching.Cache.NoAbsoluteExpiration, TimeSpan.FromMinutes(LongCacheExpiry));
        ...
        {
            if (HttpContext.Current.Cache[CacheEnum.Trans] != null)
                return (List<GetTransResult>)HttpContext.Current.Cache[CacheEnum.Trans];
            else
            {
                METAOPTION.DAL.Common objCommon = new METAOPTION.DAL.Common();
                List<GetTransResult> tran = objCommon.GetTransList();
                HttpContext.Current.Cache[CacheEnum.Trans] = tran;
                HttpContext.Current.Cache.Insert(CacheEnum.Trans, tran, null, System.Web.Caching.Cache.NoAbsoluteExpiration, TimeSpan.FromMinutes(LongCacheExpiry));
        ...
        {
            if (HttpContext.Current.Cache[CacheEnum.Engines] != null)
                return (List<GetEnginesResult>)HttpContext.Current.Cache[CacheEnum.Engines];
            else
            {
                METAOPTION.DAL.Common objCommon = new METAOPTION.DAL.Common();
                List<GetEnginesResult> engine = objCommon.GetEngineList();
                HttpContext.Current.Cache[CacheEnum.Engines] = engine;
                HttpContext.Current.Cache.Insert(CacheEnum.Engines, engine, null, System.Web.Caching.Cache.NoAbsoluteExpiration, TimeSpan.FromMinutes(LongCacheExpiry));
        ...
        {
            if (HttpContext.Current.Cache[CacheEnum.Designation] != null)
                return (List<GetDesignationResult>)HttpContext.Current.Cache[CacheEnum.Designation];
            else
            {
                METAOPTION.DAL.Common objCommon = new METAOPTION.DAL.Common();
                List<GetDesignationResult> des = objCommon.GetDesignationList();
                HttpContext.Current.Cache[CacheEnum.Designation] = des;
                HttpContext.Current.Cache.Insert(CacheEnum.Designation, des, null, System.Web.Caching.Cache.NoAbsoluteExpiration, TimeSpan.FromMinutes(LongCacheExpiry));
        ...
        {
            if (HttpContext.Current.Cache[CacheEnum.Buyers] != null)
                return (List<GetBuyerListResult>)HttpContext.Current.Cache[CacheEnum.Buyers];
            else
            {
                METAOPTION.DAL.Common objCommon = new METAOPTION.DAL.Common();
                List<GetBuyerListResult> buyers = objCommon.GetBuyerList(OrgID);
                HttpContext.Current.Cache[CacheEnum.Buyers] = buyers;
                HttpContext.Current.Cache.Insert(CacheEnum.Buyers, buyers, null, System.Web.Caching.Cache.NoAbsoluteExpiration, TimeSpan.FromMinutes(LongCacheExpiry));
        ...
        {
            return DAL.Common.EntityTypeList(isActive);
        }
        #endregion
        ...
        {
            return DAL.Common.DocumentTypeList(OrgID,isActive);
        }
        #endregion
        ...
        {
            //DAL.Common objCommon = new DAL.Common();
            //return objCommon.GetAllDealer();
            if (HttpContext.Current.Cache[CacheEnum.Dealer] != null)
                return (List<GetDealerListResult>)HttpContext.Current.Cache[CacheEnum.Dealer];
            else
            {
                METAOPTION.DAL.Common objCommon = new METAOPTION.DAL.Common();
                List<GetDealerListResult> dealer = objCommon.GetAllDealer();
                HttpContext.Current.Cache[CacheEnum.Dealer] = dealer;
                HttpContext.Current.Cache.Insert(CacheEnum.Dealer, dealer, null, System.Web.Caching.Cache.NoAbsoluteExpiration, TimeSpan.FromMinutes(LongCacheExpiry));
        ...
        {
            return DAL.Common.GetDealerCategory(isActive);
        }
        ...
        {
            return DAL.Common.LookupTableRecords(sqlStatement);
        }
        #endregion
        ...
        {
            return DAL.Common.SelectLookupTableRecords(sqlStatement);
        }
        #endregion
        ...
        {
            return (int)DAL.Common.UpdateLookupTableRecords(sqlStatement);
        }
        #endregion
        ...
        {
            return (int)DAL.Common.DeleteLookupTableRecords(sqlStatement);
        }

        #region[Edit bank Account]
        //public int EditBankAccount(Int64 BankAccountID,string AccNumber, Int16 OrgID, Int64 ModifiedBy, string MODE)
        //{
        //     METAOPTION.DAL.Common OBJ=new DAL.Common();
        //     return OBJ.EditBankAccount(BankAccountID,AccNumber, OrgID, ModifiedBy, MODE);
        //}
        #endregion
        ...
        {
            DAL.Common objCommon = new METAOPTION.DAL.Common();
        ...
        {
            return DAL.Common.GetMobileActivityDetails_Ver211(EntityTypeID, SecurityUserID);
        }
        ...
        {
            return DAL.Common.GetMobileActivityDetails_Ver211_New(EntityTypeID, IsDirectBuyer, ParentBuyerId, BuyerAccessLevel, EntityId);
        }
        //////////////////////End////////////////////////////////////

        public static List<Lane_StaticResult> LaneStatic(Char LaneType, Int16 OrgID)
        {
            return DAL.Common.LaneStatic(LaneType, OrgID);
        }
        ...
        {
            DAL.Common common = new METAOPTION.DAL.Common();
        ...
        {
            return DAL.Common.CanEntityBeDeleted(entityId, entityTypeId);
        }
        ...
        {
            return DAL.Common.DeleteEntity(entityId, entityTypeId, deletedby, deleteddate);
        }
        ...
        public void AddCustomRecordsToYMMB(long scheduledBy)
        {
            ...
            HttpContext.Current.Cache.Remove(CacheEnum.YMM);
        }
        #endregion
        ...
        {
            return DAL.Common.LaneStatic_New(OrgID);
        }
        ...
        {
            return DAL.Common.GetDataForInventorySearchDDLs(EntityID, ParentEntityID, EntityTypeID, OrgID);
        }

        public static List<GetModelResult> GetListOfModels(long makeId)
        {
            return DAL.Common.GetListOfModels(makeId);
        }
        ...
        {
            return DAL.Common.Lane_StaticForR_E_Ver211(EntityTypeId, SecurityId);
        }

        public static spSystemStats_Ver211Result SystemStats_Ver211(int SystemID, Int32 EntityiTypeId, Int32 SecurityId)
        {
            return DAL.Common.SystemStats_Ver211(SystemID, EntityiTypeId, SecurityId);
        }
        ...
        {
            return DAL.Common.spSystemStats_Dealer_Ver211(SystemID, EntityiTypeId, SecurityId);
        }
        #endregion
        ...
        {
            DAL.Common.Logout_Session(LoginHistoryID);
        }
        #endregion
        ...
        {
            System.Web.HttpContext.Current.Cache.Remove(CacheEnum.Announcement);
            System.Web.HttpContext.Current.Cache.Remove(CacheEnum.Buyers);
            System.Web.HttpContext.Current.Cache.Remove(CacheEnum.Country);
            System.Web.HttpContext.Current.Cache.Remove(CacheEnum.Dealer);
            System.Web.HttpContext.Current.Cache.Remove(CacheEnum.Designation);
            System.Web.HttpContext.Current.Cache.Remove(CacheEnum.Engines);
            System.Web.HttpContext.Current.Cache.Remove(CacheEnum.PagePermissions);
            System.Web.HttpContext.Current.Cache.Remove(CacheEnum.Trans);
            System.Web.HttpContext.Current.Cache.Remove(CacheEnum.Vendor);
            System.Web.HttpContext.Current.Cache.Remove(CacheEnum.YMM);
        }
        #endregion
        ...
        {
            return DAL.Common.Validate_QueryString_Value(EntityTypeID, EntityID, OrgID);
        }

        public static bool Validate_QueryString_Value(String Page, String Code, Int16 OrgID)
        {
            return DAL.Common.Validate_QueryString_Value(Page, Code, OrgID);
        }

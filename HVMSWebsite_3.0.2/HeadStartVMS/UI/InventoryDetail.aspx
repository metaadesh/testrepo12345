<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InventoryDetail.aspx.cs"
    Inherits="METAOPTION.UI.InventoryDetail" Title="HeadStartVMS::Inventory Detail" %>

<%@ MasterType VirtualPath="~/UI/MasterPageNoLeftPanel.Master" %>
<%@ Register Src="../UserControls/ManageInventoryStats.ascx" TagName="ManageInventoryStats"
    TagPrefix="uc1" %>
<asp:content id="Content1" contentplaceholderid="ContentPlaceHolder1" runat="server">
        ...
        <div style="display: block; width: 74%; margin-left: 26%;">
            <asp:UpdatePanel ID="updMain" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                                ...
                                <div id="dvCarDetails" runat="server" class="TableHeadingBg">
                                    <table border="0" cellpadding="0" width="100%" style="border-collapse: collapse">
                                        <tr>
                                            ...
                                            <td class="TableHeading" style="width:50px; white-space:nowrap">
                                                <asp:ImageButton ID="ibtnLaneHistory" runat="server" ToolTip="View Lane History" 
                                                    ImageUrl="~/Images/laneHistoryicon.png" 
                                                    OnClick="ibtnLaneHistory_Click" />&nbsp;
                                                <asp:ImageButton ID="ibtnAudit" runat="server" ToolTip="View Audit Trail" 
                                                    ImageUrl="~/Images/Auditicon.png" 
                                                    OnClick="ibtnAudit_Click" />
                                            </td>
                                            <td align="right" class="HeadingEditButton" style="width:50px">
                                    ...
                                    <ItemTemplate>
                                        <table width="100%" style="border-collapse: collapse">
                                            ...
                                            <tr>
                                                ...
                                                <td class="TableBorderB" id="MPrice" runat="server">
                                                    Market Price
                                                </td>
                                                <td class="TableBorder" id="MPriceVal" runat="server">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="TableBorder">
                                                            <asp:DropDownList ID="ddlBadCarFax" CssClass="txtMan1" runat="server">
                                                                <asp:ListItem Value="-1" Text="Unknown" />
                    ...
                    <div id="dvSoldTo" runat="server" class="TableHeadingBg" style="margin-top: 10px">
                        <table border="0" cellspacing="0" cellpadding="0" width="100%" style="border-collapse: collapse">
                            <tr>
                                ...
                                <td align="right" class="HeadingEditButton">
                                 <asp:ImageButton ID="ibtnSoldHistory" runat="server" ToolTip="View Sold History" 
                                                    ImageUrl="~/Images/laneHistoryicon.png" 
                                                    OnClick="ibtnSoldHistory_Click" />&nbsp;
                                    <asp:ImageButton ID="imgbtnEditSoldToDetails" runat="server" OnClientClick="ButtonDisplay();" ImageUrl="~/Images/Edit-Main-Icon.gif" />
                                    <br />
                                </td>
                            </tr>
                        </table>
                                    ...
                                    <table border="0" width="100%" cellspacing="0" cellpadding="0" style="border-collapse: collapse"
                                        ...
                                        <tr>
                                            ...
                                            <td class="GridContent_padding5">
                                                ...
                                                <ajax:AutoCompleteExtender ID="txtComeBackDealer_AutoCompleteExtender" runat="server" UseContextKey="true"
                    ...
                    <asp:Panel ID="pnlEditDealerDetails" Width="750px" runat="server" CssClass="modalPopup"
                    ...
                    <asp:Panel ID="pnlPopEditSoldTo" runat="server" Style="display: none; padding: 0px"
                        CssClass="modalPopup" Width="750px">
                        <table border="0" width="100%" cellpadding="0" cellspacing="0">
                            <tr>
                                <td class="PopUpBoxHeading">
                            ...
                            <tr>
                                <td align="left" colspan="2" style="padding: 10px">
                                <asp:HiddenField ID="hdnSetViewState" runat="server"></asp:HiddenField>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="TableBorder" nowrap="nowrap" colspan="3"  >
                                                       <div style="float : left;">
                                                        <asp:TextBox ID="txtCustomerName" MaxLength="50" Width="400px" CssClass="txtMan2" Text='<%#Eval("DealerName")%>'
                                                            runat="server" ReadOnly="True"></asp:TextBox>
                                                            
                                                            </div>
                                                            <div >
                                                        <asp:LinkButton ID="lnkSelectCustomer" OnClientClick="$find('mdpopupSoldTo').hide();return false;"
                                                            runat="server" Text="Select Customer" CssClass="GridContent_Link"></asp:LinkButton><br />
                                                          
                                                             <a ID="lnkRemoveCustomer" onclick="RemoveCustomer();" style=" cursor : pointer;"
                                                              Class="GridContent_Link">Remove Customer</a></div>
                            ...
                            <tr>
                                <td colspan="2">
                                    <asp:GridView ID="gvAudit" runat="server" AutoGenerateColumns="false"
                                        ...
                                        AlternatingRowStyle-CssClass="gvAlternateRow" EmptyDataText="No record found"
                                        AllowPaging="true" PageSize="10" OnPageIndexChanging="gvAudit_PageIndexChanging" >
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Updated From" ItemStyle-CssClass="GridContent" HeaderStyle-CssClass="GridContent" ItemStyle-Width="100px">
                                                <ItemTemplate>
                                                    <%#Eval("Source")%> (<%#Eval("UpdateFrom")%>)
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Modified On" ItemStyle-CssClass="GridContent" HeaderStyle-CssClass="GridContent" ItemStyle-Width="120px">
                                                <ItemTemplate>
                    ...
                    <%--Lane History PopUp Begin--%>
                    <asp:Panel ID="pnlLaneHistory" CssClass="modalPopup" Style="display: none; height: auto;
                        width: 800px;" runat="server" HorizontalAlign="Left">
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                <td class="PopUpBoxHeading">
                                ...
                                <td class="PopUpBoxHeading" align="right">
                                    <img id="imgCloseLaneHistory" border="0" src="../Images/close.gif" alt="close" />
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <asp:GridView ID="gvLaneLog" runat="server" AutoGenerateColumns="false"
                                        GridLines="None" Width="100%" RowStyle-CssClass="gvRow" CssClass="Grid"
                                        AlternatingRowStyle-CssClass="gvAlternateRow" EmptyDataText="No record found"
                                        AllowPaging="true" PageSize="10" OnPageIndexChanging="gvLaneLog_PageIndexChanging" >
                                        <Columns>
                                            <asp:BoundField HeaderText="Field" DataField="FieldName" ItemStyle-CssClass="GridContent" HeaderStyle-CssClass="GridContent" SortExpression="Field" />
                                            <asp:BoundField HeaderText="Old Value" DataField="NewValue" ItemStyle-CssClass="GridContent" HeaderStyle-CssClass="GridContent" />                                           
                                            <asp:BoundField HeaderText="New Value" DataField="CurrentValue" ItemStyle-CssClass="GridContent" HeaderStyle-CssClass="GridContent" />
                                            <asp:TemplateField HeaderText="Added On" ItemStyle-CssClass="GridContent" HeaderStyle-CssClass="GridContent" ItemStyle-Width="120px">
                                                <ItemTemplate>
                                                    <%#Eval("DateAdded")%> <br /> <%#Eval("AddedBy")%> 
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:BoundField HeaderText="Source" DataField="SourcePage" ItemStyle-CssClass="GridContent" HeaderStyle-CssClass="GridContent" SortExpression="Source" />
                    ...
                    <asp:HiddenField ID="hfLaneHistory" runat="server" />
                    <ajax:ModalPopupExtender ID="mpeLaneHistory" runat="server" BackgroundCssClass="modalBackground"
                        TargetControlID="hfLaneHistory" PopupControlID="pnlLaneHistory" CancelControlID="imgCloseLaneHistory" >
                    </ajax:ModalPopupExtender>
                    <%--Lane History PopUp End--%>

              <%--     View Sold to History Begin --%>
               <asp:Panel ID="pnlSoldHistory" CssClass="modalPopup" Style="display: none; height: auto;
                        width: 800px;" runat="server" HorizontalAlign="Left">
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                <td class="PopUpBoxHeading">
                                ...
                                <td class="PopUpBoxHeading" align="right">
                                    <img id="imgSOLDHISTORY" border="0" src="../Images/close.gif" alt="close" />
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <asp:GridView ID="gvSoldHistory" runat="server" AutoGenerateColumns="false"
                                        GridLines="None" Width="100%" RowStyle-CssClass="gvRow" CssClass="Grid"
                                        AlternatingRowStyle-CssClass="gvAlternateRow" EmptyDataText="No record found"
                                        AllowPaging="true" PageSize="10" OnPageIndexChanging="gvSoldHistory_PageIndexChanging" >
                                        <Columns>
                                         <asp:TemplateField HeaderText="Dealer" ItemStyle-CssClass="GridContent" HeaderStyle-CssClass="GridContent" >
                                                <ItemTemplate>
                                                 <%# String.Format("{0} ", Eval("DealerName") )%>
                                                 <asp:Label id="lblStatus" runat="server" Text='<%#  Eval("RemoveStatus")  %>'
                                               CssClass='<%# String.Format("{0}", Convert.ToString(Eval("RemoveStatus")) == "Added" ? "RemoveStatusGreenColor" : "RemoveStatusRedColor")  %>'
                                              
                                                  />
                                                </ItemTemplate>
                                                </asp:TemplateField>
                                           
                                            <asp:BoundField HeaderText="Address" DataField="Address" ItemStyle-CssClass="GridContent" HeaderStyle-CssClass="GridContent" />
                                            <asp:BoundField HeaderText="Phone" DataField="Phone" ItemStyle-CssClass="GridContent" HeaderStyle-CssClass="GridContent" />
                                              <asp:TemplateField HeaderText="Sold Date" ItemStyle-CssClass="GridContent" HeaderStyle-CssClass="GridContent" ItemStyle-Width="120px">
                                                <ItemTemplate>
                                                    <%# String.Format("{0: MM/dd/yyyy}" ,Eval("SoldDate"))%>   
                                                </ItemTemplate>
                                            </asp:TemplateField>                                           
                                            <asp:TemplateField HeaderText="Added On" ItemStyle-CssClass="GridContent" HeaderStyle-CssClass="GridContent" ItemStyle-Width="120px">
                                                <ItemTemplate>
                                                  <%# String.Format("{0} on {1}", Eval("UserName"), Eval("DateModifed"))%>  
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                        <EmptyDataRowStyle CssClass="gvEmpty" />
                    ...
                    <asp:HiddenField ID="hfSolddHistory" runat="server" />
                    <ajax:ModalPopupExtender ID="mpeSoldHistory" runat="server" BackgroundCssClass="modalBackground"
                        TargetControlID="hfSolddHistory" PopupControlID="pnlSoldHistory" CancelControlID="imgSOLDHISTORY" >
                    </ajax:ModalPopupExtender>

                    <%-- View Sold to History End  --%>
                </ContentTemplate>
                <Triggers>
    ...
    <script type="text/javascript">
       function pageLoad() {
        var EntityType = "<%= Session["LoginEntityTypeID"]%>";
            ...
            if(EntityType == "1")
            {
             ...
             $('#ctl00_ContentPlaceHolder1_frmCarDetails_MPrice').html(" ");
             $('#ctl00_ContentPlaceHolder1_frmCarDetails_MPriceVal').html(" ");
            }
        }
        window.onload = pageLoad;
       function RemoveCustomer()
       {
         $('#lnkRemoveCustomer').show();
       $('#ctl00_ContentPlaceHolder1_frmEditSoldTo_txtCustomerName').val('');
       $('#ctl00_ContentPlaceHolder1_hdSelDealerId').val('-1');
         $('#ctl00_ContentPlaceHolder1_hdnSetViewState').val('0');
         $('#lnkRemoveCustomer').hide();
       ...
       function ButtonDisplay(){
        ...
        if($('#ctl00_ContentPlaceHolder1_frmEditSoldTo_txtCustomerName').val()== '')
           $('#lnkRemoveCustomer').hide();
           else
           $('#lnkRemoveCustomer').show();
       }
    ...
    <Style type="text/css">
        .RemoveStatusRedColor
        {
            color: Red;
        }
        .RemoveStatusGreenColor
        {
            color: Green;
        }
    </Style>

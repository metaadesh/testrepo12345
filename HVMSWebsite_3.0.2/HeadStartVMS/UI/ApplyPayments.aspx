<%@ Page Language="C#"  AutoEventWireup="true"
    CodeBehind="ApplyPayments.aspx.cs" Inherits="METAOPTION.UI.ApplyPayments" Title="HeadStart VMS :: Apply Payments"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript" language="javascript">
        ...
        function SelectAllCheckboxes(chk) {
            var counter = 0;
            $('#<%=grvOpenExpenses.ClientID%>').find("input:checkbox").each(function () {
                if (this != chk) {
                ...
                <table border="0" width="100%" cellpadding="0" style="border-collapse: collapse">
                    ...
                    <tr>
                        ...
                        <td class="GridContent" width="25%">
                            ...
                            <asp:HiddenField ID="hdnGLPurchaseAccountGUID" runat="server" />
                            <asp:HiddenField ID="hdnGLPurchaseAccount" runat="server" />
                            ...
                            <asp:Panel runat="server" ID="pnlAccountingCode" Style="display: none; background: #f0f0f0;">
                                <table border="0" width="750" cellpadding="0" class="PopUpBox">
                                    <tr>
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateField HeaderStyle-Width="25px" HeaderStyle-CssClass="GridHeader" ItemStyle-CssClass="GridContent">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:HiddenField ID="hdnGLPurchaseAccountGUID" runat="server" Value='<%# Eval("GLPurchaseAccountGUID")%>' />
                                                                <asp:HiddenField ID="hdnGLPurchaseAccount" runat="server" Value='<%# Eval("GLPurchaseAccount")%>' />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:BoundField DataField="GLPurchaseAccountGUID" HeaderText="GL Pur. Acc. GUID"
                                                            SortExpression="GLPurchaseAccountGUID" HeaderStyle-CssClass="GridHeader" ItemStyle-CssClass="GridContent">
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="GLPurchaseAccount" HeaderText="GL Pur. Acc." SortExpression="GLPurchaseAccount"
                                                            HeaderStyle-CssClass="GridHeader" ItemStyle-CssClass="GridContent"></asp:BoundField>
                                                    </Columns>
                                                </asp:GridView>
                                            </div>
                    ...
                    <tr>
                        <td class="TableHeadingBg TableHeading" colspan="2">
                            ...
                            <div style="float: right; width: 300px; text-align: right; padding-right: 5px; text-transform: capitalize;">
                                <%--<asp:LinkButton ID="btnSelectAll" runat="server" CssClass="BlackTxt_Link" OnClientClick="SelectAllCheckboxes(this);" OnClick="btnSelectAll_Click" ToolTip="Select/Unselect from open expenses list" Text="Select All"> </asp:LinkButton>
                                &nbsp;&nbsp;|&nbsp;&nbsp;--%>
                                <asp:LinkButton ID="btnAddToSelectedList" runat="server" CssClass="BlackTxt_Link"
                                    OnClick="btnAddToSelectedList_Click" ToolTip="Click here add the selected expense(s) from open expense(s) list to selected expense(s) list.">Add To Selected Expenses</asp:LinkButton>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td class="TableBorder" colspan="2">
                            <asp:GridView ID="grvOpenExpenses" runat="server" DataKeyNames="ObjectId" AutoGenerateColumns="false"
                                ...
                                EmptyDataRowStyle-CssClass="GridEmptyRow" OnRowDataBound="grvOpenExpenses_RowDataBound">
                                <PagerStyle CssClass="FooterContentDetails" HorizontalAlign="Right" />
                                <Columns>

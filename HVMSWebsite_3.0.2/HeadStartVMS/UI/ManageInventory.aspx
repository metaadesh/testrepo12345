...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="width:100%; position:relative;  ">
        <div style="display: inline-block; vertical-align: top; padding: 6px; background-color: #E4EDF4; width:24%; position:absolute; top:0; bottom:0;">
        ...
        <div style="display:block; width: 74%; margin-left:26%">
            <asp:UpdatePanel ID="updMain" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    ...
                    <table id="" border="0" width="100%" cellpadding="0" style="border-collapse: collapse; margin-top:10px;">
                        <tr>
                            <td colspan="2">
                                ...
                                <asp:FormView ID="frmCarDetails" Width="100%" runat="server" OnDataBound="frmCarDetails_DataBound">
                                    <ItemTemplate>
                                        <table width="100%" style="border-collapse: collapse">
                                            ...
                                            <tr>
                                                <td class="TableBorderB">Regular #</td>
                                                <td class="TableBorderB">Exotic #</td>
                                                <td class="TableBorderB">Virtual #</td>
                                                <td class="TableBorderB">Online #</td>
                                            </tr>
                                            <tr>
                                                <td class="TableBorder"><%#Eval("RegularLane")%></td>
                                                <td class="TableBorder"><%#Eval("ExoticLane")%></td>
                                                <td class="TableBorder"><%#Eval("VirtualLane")%></td>
                                                <td class="TableBorder"><%#Eval("OnlineLane")%></td>
                                            </tr>
                                            ...
                                            <tr class="TableBorderB">
                                                ...
                                                <td class="TableBorderB">Car Location</td>
                                                <td class="TableBorder"><%#Eval("CarLocation")%></td>
                                            </tr>
                            
                            
                                            <tr class="TableBorderB">
                                                <td class="TableBorderB">Year</td>
                                                <td class="TableBorder"><font color="red"><b><%#Eval("Year")%></b></font></td>

                                                <td class="TableBorderB">
                                                    Mileage In
                                                </td>
                                                <td class="TableBorder">
                                                    <font color="red"><b><%#Eval("MileageIn")%></b></font>
                                            ...
                                            <tr>
                                                <td class="TableBorderB">Make</td>
                                                <td class="TableBorder"><font color="red"><b><%#Eval("Make")%></b></font></td>

                                                <td class="TableBorderB">Exterior Color</td>
                                                <td class="TableBorder"><%#Eval("Ext1Desc")%></td>
                                            </tr>
                            
                                            <tr>
                                                <td class="TableBorderB">Model</td>
                                                <td class="TableBorder"><font color="red"><b><%#Eval("Model")%></b></font></td>
                                
                                                <td class="TableBorderB">Interior Color</td>
                                                <td class="TableBorder"><%#Eval("IntDesc")%></td>
                                            </tr>
                                            <tr>
                                                <td class="TableBorderB">Body</td>
                                                <td class="TableBorder"><%#Eval("Body")%></td>

                                                <td class="TableBorderB">Special Equipment</td>
                                                <td class="TableBorder"><%#Eval("DesignatedEquipment")%></td>
                                            </tr>
                                             <tr>
                                                <td class="TableBorderB">Bad CARFAX</td>
                                                <td class="TableBorder"><%#Convert.ToBoolean(Eval("BadCarFax"))==true?"Yes": "No"%></td>
                                                <td class="TableBorderB">Grade</td>
                                                <td class="TableBorder"><%#Eval("Grade")%></td>
                                            </tr>
                                            <tr>
                                                <td class="TableBorderB">Vehicle Present</td>
                                                <td class="TableBorder"><%# Convert.ToBoolean(Eval("VehiclePresent"))== true?"Yes" : "No" %></td>

                                                <td class="TableBorderB">Arrival Date</td>
                                                <td class="TableBorder"><%#Eval("ArrivalDate")%></td>
                                            </tr>
                                            <tr>
                                                <td class="TableBorderB">Average MMR</td>
                                                <td class="TableBorder">&nbsp;</td>
                                                <td class="TableBorderB">Engine</td>
                                                <td class="TableBorder"><%#Eval("EngineType")%></td>
                                            </tr>
                                            <tr>
                                                <td class="TableBorderB">Wheel Drive</td>
                                                <td class="TableBorder"><%#Eval("WheelDrive")%></td>
                                                <td class="TableBorderB">Trans</td>
                                                <td class="TableBorder"><%#Eval("TransType")%></td>
                                            </tr>
                            
                                            <tr>
                                                <td class="TableBorderB">Note</td>
                                                <td class="TableBorder" colspan="3"><%#Eval("CarNote")%></td>
                                            </tr>
                                            <tr>
                                                <td class="TableBorderB">Special Case Note</td>
                                                <td class="TableBorder" colspan="3"><%#Eval("SpecialCaseNote")%></td>
                                            </tr>
                            
                                            <tr runat="server" id="trOldMMBC">
                                                <td class="TableBorderB">Old MMBC</td>
                                ...
                                <asp:Panel ID="pnlPopEditCarDet" runat="server" Style="display: none;padding:0px;" CssClass="modalPopup"
                                    Width="700px">
                                    <div>
                                        ...
                                        <asp:FormView ID="frmCarDetailsUpdate" runat="server" Width="100%" OnDataBound="frmCarDetailsUpdate_DataBound">
                                            <ItemTemplate>
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                    ...
                                                    <tr>
                                                        <td class="TableBorderB">Year</font></td>
                                                        <td class="TableBorder">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="TableBorderB">Regular Lane Number</td>
                                                        <td class="TableBorder">
                                                    ...
                                                    <tr>
                                                        <td class="TableBorderB">Exotic Lane Number</td>
                                                        <td class="TableBorder">
                                                        ...
                                                        <td class="TableBorderB">Virtual Lane Number</td>
                                                        <td class="TableBorder">
                                                            <asp:TextBox ID="txtVirLaneNoPopUp" 
                                                                CssClass="txt1"  
                                                                Text='<%#Eval("VirtualLane")%>' 
                                                                MaxLength="7"
                                                                runat="server" />
                                                    ...
                                                    <tr>
                                                        <td class="TableBorderB">Online Lane Number</td>
                                                        <td class="TableBorder">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="TableBorderB" colspan="2">&nbsp;</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="TableBorderB">Note</td>
                                                        <td class="TableBorder" colspan="3">
                    ...
                    <table border="0" width="100%" cellpadding="0" style="border-collapse: collapse; margin-top:10px">
                        <tr>
                            <td colspan="2">
                                ...
                                <asp:FormView ID="frmCarProp" Width="100%" runat="server">
                                    <ItemTemplate>
                                        <table width="100%" style="border-collapse: collapse">
                                            <tr>
                                                <td class="TableBorderB">AC</td>
                                                <td class="TableBorder"><%#Eval("AC")%></td>
                                                <td class="TableBorderB">Sun Roof</td>
                                                <td class="TableBorder"><%#Eval("SunMoon")%></td>
                                            </tr>
                                            <tr>
                                                <td class="TableBorderB">Power Locks</td>
                                                <td class="TableBorder"><%#Eval("PowerLocks")%></td>
                                                <td class="TableBorderB">Leather</td>
                                                <td class="TableBorder"><%#Eval("Leather")%></td>
                                            </tr>
                                            <tr>
                                                <td class="TableBorderB">Power Windows</td>
                                                <td class="TableBorder"><%#Eval("PowerWindows")%></td>
                                                <td class="TableBorderB">Navigation</td>
                                                <td class="TableBorder"><%#Eval("Navigation")%></td>
                                            </tr>
                                            <tr>
                                                <td colspan="4" class=" FooterContentDetails"><asp:Label ID="lblCarPropHistory" runat="server" Text='<%# Eval("UpdatedHistory") ?? "&nbsp;"%>'></asp:Label></td>
                                            </tr>
                                        </table>
                                    </ItemTemplate>
                                </asp:FormView>
                            ...
                            <ItemTemplate>
                                <table border="0" width="100%" cellpadding="0" style="border-collapse: collapse">
                                    ...
                                    <tr>
                                        ...
                                        <td class="TableBorder" colspan="3">
                                            <font color="red"><b><%#Eval("DealerName")%></b></font>
                                        </td>
                                     </tr>
                                     <tr>   
                                        <td class="TableBorderB">
                    ...
                    <div>
                        ...
                        <table id="pnlComeBackDetails" runat="server" style="display: none;padding:0px;" class="modalPopup"
                        ...
                        <tr>
                                <td style="text-align:left; padding:10px 10px 10px 0px;font-size:12px; font-weight:bold">
                                    <asp:HyperLink ID="HyperLink1" runat="server" CssClass="btn" 
                                        style="padding:3px 4px; text-decoration:none"
                                        Text="<< Back To Search" NavigateUrl="~/UI/InventorySearch.aspx" />
                                </td>
                            </tr>

                    </table>
                    <asp:Panel ID="pnlPopEditCarProp" Width="550px" runat="server" Style="display: none; padding:0px"
                        CssClass="modalPopup">
                    ...
                    <asp:Panel ID="pnlEditDealerDetails" Width="700px" runat="server" CssClass="modalPopup" Style=" padding:0px" >
                                        ...
                                        <ItemTemplate>
                                            <table width="100%" style="border-collapse: collapse">
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left" class="TableBorder">
                                                        <asp:DropDownList ID="ddlDupTitle" runat="server" AutoPostBack="true"
                                                            CssClass="txt1" OnSelectedIndexChanged="ddlDupTitle_SelectedIndexChanged">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="TableBorder" colspan="2">
                                                        ...
                                                        <asp:UpdatePanel ID="updDupTitleNote" UpdateMode="Conditional" runat="server">
                                                            ...
                                                            <ContentTemplate>
                                                                <asp:TextBox ID="txtDupTitleNote" Width="100%" Rows="3" CssClass="txtMulti"
                                                                    TextMode="MultiLine" Text='<%#Eval("DupTitleNote")%>' runat="server" onkeyup="CheckMaxCharLimit(this, 'ctl00_ContentPlaceHolder1_frmViewEditDealerDetails_txtCountDupTitleNoteChar', 255)" />
                    ...
                    <asp:Panel ID="pnlPopEditSoldTo" runat="server" Style="display: none;padding:0px" CssClass="modalPopup"
                        Width="700px">
                        <table border="0" width="100%" cellpadding="0" cellspacing="0">
                            <tr>
                                <td class="PopUpBoxHeading">
                        ...
                        <div>
                            ...
                            <div style="padding: 5px 0px 0px 15; margin: 5px 0px 10px 30px">
                                ...
                                <asp:Button ID="btnCRcancel2" runat="server" Text="Cancel" CssClass="btn" Width="80px"
                                    OnClick="btnCRcancel_Click" />&nbsp;&nbsp;&nbsp;
                                <asp:HyperLink ID="hlnkViewReport" runat="server" Text="View Report"
                                    Target="_blank" CssClass="btn" Width="100px" />
                            </div>
                        </div>
                    </div>

<%@ Page Language="C#" AutoEventWireup="True" 
    CodeBehind="LookUpTables.aspx.cs" Inherits="METAOPTION.UI.LookUpTables" EnableEventValidation="false"
    Title="HeadstartVMS::Lookup View" %>

<asp:Content ID="lookup" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <td class="TableBorder">
                <table border="0" width="100%" cellpadding="0" style="border-collapse: collapse">
                    <tr style="padding-top: 10px;">
                        <td class="TableBorder" style="width: 15%" nowrap>
                    ...
                    <tr style="padding-top: 10px;">
                        ...
                        <td class="TableBorder" style="width: 100%">
                            ...
                            <div style="text-align:center;width:100%"><asp:UpdateProgress ID="UpdateProgress1" runat="server" DisplayAfter="10">
                            <ProgressTemplate>
                                ...
                                <ContentTemplate>
                                    <asp:Panel ID="pnlEdit" runat="server" Visible="false">
                                        <asp:GridView ID="gvLookUpTables" runat="server" AllowPaging="True" OnPageIndexChanging="gvLookUpTables_PageIndexChanging"
                                            ...
                                            DataKeyNames="id" OnRowDataBound="gvLookUpTables_RowDataBound" OnRowDeleting="gvLookUpTables_RowDeleting" EmptyDataText="No Record Found"
                                            AllowSorting="True" OnSorting="gvLookUpTables_Sorting">
                                            <Columns>
                                                <asp:TemplateField>
                                                    <EditItemTemplate>
                                    ...
                                    <asp:Panel ID="pnlView" runat="server" Visible="false">
                                        <asp:GridView ID="gvViewOnly" runat="server" AllowPaging="True" PageSize="50" Width="100%"
                                            OnPageIndexChanging="gvViewOnly_PageIndexChanging" AllowSorting="True" OnSorting="gvViewOnly_Sorting" EmptyDataText="No Record Found">
                                            <HeaderStyle CssClass="gvHeading" />
                                    ...
                                    <asp:Panel ID="pnlReActive" runat="server" Visible="false">
                                        <asp:GridView ID="gvInActive" runat="server" AllowPaging="True" DataKeyNames="id"
                                            PageSize="50" Width="100%" OnRowDeleting="gvInActive_RowDeleting" AllowSorting="True" EmptyDataText="No Record Found"
                                            OnSorting="gvInActive_Sorting" OnRowDataBound="gvInActive_RowDataBound" >
                                            <Columns>
                                ...
                                <asp:UpdatePanel ID="updPnlCustomerDetail" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        ...
                                        <div>
                                            ...
                                            <asp:DetailsView ID="dvLookupTables" runat="server" GridLines="None" DefaultMode="Edit"
                                    ...
                                    <ContentTemplate>
                                        ...
                                        <div>
                                            ...
                                            <asp:DetailsView ID="dvAddBankAccount" runat="server" AutoGenerateRows="false" DefaultMode="Insert"
                                                GridLines="None" Width="100%" BorderColor="White" BorderWidth="5px" >
                                                <Fields>
                                                    <asp:TemplateField HeaderText="Bank ID">
                                                        <InsertItemTemplate>
                                                            <asp:DropDownList ID="ddlBankId" runat="server" CssClass="GridContent" DataSourceID="odsBankId" width="60%"
                                                    ...
                                                    <asp:TemplateField HeaderText="Account Number">
                                                        <InsertItemTemplate>
                                                            <asp:TextBox ID="txtAccountNumber" runat="server" Text='<%# Bind("AccountNumber") %>'  width="60%"
                                    ...
                                    <ContentTemplate>
                                        ...
                                        <div>
                                            <div style="text-align: center">
                                                ...
                                                <asp:Button ID="btnStateClose" runat="server" Text="Cancel" CausesValidation="false" CssClass="Btn_Form" />
                                                &nbsp;&nbsp;
                            ...
                            <asp:UpdatePanel ID="upAdd" runat="server">
                                <ContentTemplate>
                                    <div class="FooterContentDetails" style="width: 100%" id="dvAdd" runat="server" visible="false">
                                        <asp:LinkButton class="AddNewExpenseTxt" ID="lnkAdd" runat="server" CausesValidation="false" OnClick="lnkAdd_Click"></asp:LinkButton>
                                    </div>
                                </ContentTemplate>
                            </asp:UpdatePanel>
                            <%-- End --%>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BuyerDefault.aspx.cs" EnableEventValidation="false"
    Title="HeadstartVMS::Home Page" Inherits="METAOPTION.BuyerDefault" %>
...
<asp:content contentplaceholderid="ContentPlaceHolder1" id="cphDefault" runat="server">
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="0">
      <tr>
              ...
              <table border="0" width="220" cellpadding="0" style="border-collapse: collapse" id="tableSearch">
               ...
               <tr id="trSearchPayment">
                ...
                <tr id="trTitles">
                  <td>
                     <img border="0" src="../images/Buller-1.gif" width="9" height="9" alt="" />
                     &nbsp;<asp:HyperLink NavigateUrl="ViewAllTitleStatus.aspx" ID="hlnktitles" runat="server"
                        class="OrangeText_Link">Click 
                     here to search Titles</asp:HyperLink>
                  </td>
               </tr>
            </table>
         </td>
         ...
         <td align="left" valign="top" class="Container">
               <table border="0" width="220" cellpadding="0" style="border-collapse: collapse" id="tableMobile">
               <tr>
                  <td align="center">
                     <asp:HyperLink NavigateUrl="PreInventory.aspx" ID="hlnkDealerListImg" runat="server"
                        ...
                        <img border="0" src="../images/defmobile.png"  width="52" height="54" style="padding-bottom: 10px; padding-top: 10px;"
                           alt="Customer/Dealer" title="Click to view Pre-Inv/Pre-Expense/Location/Scan Log/......" />
                     </asp:HyperLink>
                  </td>
               </tr>
               <tr>
                  <td class="ContainerHaeding" align="center">
                     <asp:HyperLink NavigateUrl="PreInventory.aspx" ID="hlnkDealerListHead" runat="server"
               ...
               <tr>
                  <td height="20" valign="top">
                     <div class="DivTxt_Normal">
                        This section allows you to view the Pre Expense, Location, VIN scan log and Generic Images.. </div>
                  </td>
               </tr>
                <tr>
                  <td height="5">
               ...
               <tr>
                  <td>
                     <img border="0" src="../images/Buller-1.gif" width="9" height="9" alt="" />
                     &nbsp;<asp:HyperLink NavigateUrl="PreInventory.aspx" ID="hlnkPreInv" runat="server"
               ...
               <tr id="trPreExpense">
                  <td>
                     <img border="0" src="../images/Buller-1.gif" width="9" height="9" alt="" />
                     &nbsp;<asp:HyperLink NavigateUrl="PreExpense.aspx" ID="hlnkAddCustomertxt" runat="server"
                        class="OrangeText_Link">Click here to view Mobile-Expense</asp:HyperLink>
                  </td>
               </tr>
             
               <tr  id="trViewLocation" >
                  <td>
                     <img border="0" src="../images/Buller-1.gif" width="9" height="9" alt="" />
         ...
         <td align="left" valign="top" class="Container" id="tdap" >
             <table border="0" width="220" cellpadding="0" style="border-collapse: collapse" id="tableAccountPayble">
               <tr>
                  <td align="center">
         ...
         var AccessLevel = "<%= Session["BuyerAccessLevel"]%>";
          var IsDirectBuyer = "<%= Session["BuyerIsDirect"]%>";
            if (EntityType == "2" && AccessLevel== "1" && IsDirectBuyer == "False" ) {
             $('#trSearchPayment').hide();
             $('#trPreExpense').hide();
             $('#trViewLocation').hide();
             $('#trVinScanLog').hide();
             $('#trGeneImg').hide();
             $('#tableAccountPayble').css("display", "none");
             $('#trTitles').hide();
              $('#tdap').removeAttr('class');     
              $('#tableMobile').attr("width", "200px"); 
              $('#tableSearch').attr("width", "200px");     
               $('#tdap').css('width', "280px");
               $('#tdtext').attr("height", "20px"); 
            }

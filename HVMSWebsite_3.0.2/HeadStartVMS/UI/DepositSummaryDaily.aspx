<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="DepositSummaryDaily.aspx.cs"
    MasterPageFile="~/UI/MasterPageNoLeftPanel.Master" Inherits="METAOPTION.UI.DepositSummaryDaily" %>
        ...
        <asp:UpdatePanel ID="upResultSearch" runat="server" UpdateMode="Conditional">
            ...
            <ContentTemplate>
                ...
                <div style="clear: both;">
                    ...
                    <div>
                        <asp:GridView ID="grvDepositSummary" runat="server" DataKeyNames="DepositDate" Width="100%"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="Deposit Date" HeaderStyle-CssClass="GridHeader" SortExpression="DepositDate"
                                    ...
                                    <ItemTemplate>
                                        ...
                                        &nbsp;
                                        <asp:HyperLink ID="hylnkView" ToolTip="Deposit Detail" NavigateUrl='<%# "InventoryDepositSearch.aspx?To="+Eval("DepositDate", "{0:M/d/yyyy}") %>'
                                            runat="server" Text='<%#Eval("DepositDate", "{0:M/d/yyyy}")%>' />
                                    </ItemTemplate>
                                </asp:TemplateField>

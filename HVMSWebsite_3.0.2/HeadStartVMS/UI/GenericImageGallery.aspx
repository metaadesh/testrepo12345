<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GenericImageGallery.aspx.cs"
    Inherits="METAOPTION.GenericImageGallery" %>
            ...
            <asp:DataList ID="dlthumb" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
                ...
                <ItemTemplate>
                    <li><a href='<%# GetImagePath(Eval("ServerPath"))  %>'>
                        <img src='<%# GetImagePath(Eval("ThumbNailPath")) %>' alt='<%# GetDesc(Eval("ImageID")) %>' onerror="this.src='../Images/nocarthumb.png'"
                            class="image0">
                    </a></li>
                </ItemTemplate>
                <FooterTemplate>

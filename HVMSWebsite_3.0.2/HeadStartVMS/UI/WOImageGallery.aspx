<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WOImageGallery.aspx.cs" Inherits="METAOPTION.UI.WOImageGallery" %>
...
<head>
    ...
    <title>HeadStart VMS :: Work Order</title>
</head>
<body>
    <div id="container">
        <div id="gallery" class="ad-gallery">
            <div style="margin-bottom: 5px;">
                <span id="spHeader0" runat="server" style="color: #21618C; font-family: Arial,Helvetica,sans-serif;
                    font-size: 12px; font-weight: normal; text-decoration: none;"></span>
                <span id="spHeader1" runat="server" style="color: red; font-family: Arial,Helvetica,sans-serif; font-size: 12px;
                    font-weight: bold; text-decoration: none;"></span>
                <span id="spHeader2" runat="server" style="color: #21618C; font-family: Arial,Helvetica,sans-serif; font-size: 12px;

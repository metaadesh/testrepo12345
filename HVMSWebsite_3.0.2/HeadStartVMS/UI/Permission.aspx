<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Permission.aspx.cs" Inherits="METAOPTION.UI.Permission" %>
...
<body>
   ...
   <center style="padding-top: 80px;">
      <table border="0" id="tblForget" cellpadding="0" cellspacing="0"
         ...
         <tr>
            <td >
               <p style="width: 745px; text-align: center; font-weight: bold;" id="paradefault" runat="server">
                  Click <a id="hlnkDefault" runat="server" href="Default.aspx" title="click to go back to Home page">here </a>to go
                  back to Home page
               </p>
               <p style="width: 745px; text-align: center; font-weight: bold;" id="paralogin" runat="server">
                  Click <a href="../Login.aspx" title="click to go back to Login page">here </a>to go
                  back to Login page
               </p>
            </td>
         </tr>

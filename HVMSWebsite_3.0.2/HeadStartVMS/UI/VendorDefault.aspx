<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VendorDefault.aspx.cs"
    Title="HeadstartVMS::Home Page" Inherits="METAOPTION.UI.VendorDefault" %>
      ...
      <tr>
         ...
         <td align="left" valign="top" class="Container">
            <table border="0" width="220" cellpadding="0" style="border-collapse: collapse">
               <tr>
                  <td align="center">
                     <asp:HyperLink NavigateUrl="CompanyExpenseType.aspx" runat="server" ID="hlnkInventorySearchimg"
                        title="Click to view Company Expense Type">
                         <%--<img border="0" src="../images/Search-Icon.gif" width="52" height="54" alt="" />--%>
                         <img border="0"  src="../Images/expenses.png"  width="52" height="54" style="padding-bottom: 10px; padding-top: 10px;" alt="" />
                     </asp:HyperLink>
                  </td>
               </tr>
               <tr>
                  <td class="ContainerHaeding" align="center">
                     <asp:HyperLink NavigateUrl="CompanyExpenseType.aspx" runat="server" ID="hlnkInventorySearchHead"
                        class="ContainerHaeding" Style="text-decoration: none;">
                        Expenses Type</asp:HyperLink>
                  </td>  
               </tr>
               <tr>
                  <td>
               ...
               <tr>
                  <td height="20" valign="top">
                     <div class="DivTxt_Normal">
                        This section provides you to view the Company Expenses Type </div>
                  </td>
               </tr>
               ...
               <tr>
                  <td>
                    <%-- <img border="0" src="../images/Buller-1.gif" width="9" height="9" alt="" />
                     &nbsp;
                     <asp:HyperLink NavigateUrl="CompanyExpenseType.aspx" runat="server" ID="hlnkInventorySearchtxt"
                        class="OrangeText_Link">Click 
                     here to view Authorize Expense Type</asp:HyperLink>--%>
                  </td>
               </tr>
               <tr><td height="5">&nbsp;&nbsp;&nbsp;</td> </tr>
               <tr>
                  <td>
                     <img border="0" src="../images/Buller-1.gif" width="9" height="9" alt="" />
                     &nbsp;<asp:HyperLink NavigateUrl="CompanyExpenseType.aspx" ID="hlnkSearchPaymenttxt" runat="server"
                        class="OrangeText_Link">Click 
                     here to view Authorize Expense Type</asp:HyperLink>
                  </td>
               </tr>
               ...
               <tr>
                  <td>
                     ...
                     &nbsp;<asp:HyperLink NavigateUrl="PreExpense.aspx" ID="hlnkAddCustomertxt" runat="server"
                        class="OrangeText_Link">Click here to view Pre-Expense</asp:HyperLink>
                  </td>
               </tr>

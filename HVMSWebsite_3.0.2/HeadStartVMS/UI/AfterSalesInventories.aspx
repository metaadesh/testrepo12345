                    ...
                    <asp:UpdatePanel ID="updPnlAfterSales" runat="server" UpdateMode="Conditional">
                        ...
                        <ContentTemplate>
                            <asp:GridView ID="gvAfterSales" 
                                ...
                                <PagerStyle CssClass="FooterContentDetails" HorizontalAlign="Right" Width="100%" />
                            </asp:GridView>
                            <asp:ObjectDataSource ID="objAfterSalesData" runat="server" SelectMethod="GetAfterSalesData"
                                ...
                                <SelectParameters>
                                    ...
                                    <asp:SessionParameter DefaultValue="-1" Name="SystemID" SessionField="systemid" 
                                    Type="Int32" />
                                    <asp:ControlParameter ControlID="lblOrgID" DefaultValue="-1" Name="OrgID"
                                        PropertyName="Text" Type="String" />
                                </SelectParameters>

<%@ Page Title="" Language="C#" MasterPageFile="~/UI/BuyerMasterPage.Master" AutoEventWireup="true"
    CodeBehind="BuyerSystemStats.aspx.cs" Inherits="METAOPTION.UI.BuyerSystemStats" %>
            ...
            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                <tr id="trUnpaidInventory" runat="server">
                    ...
                    <td class="TableBorder">
                        ...
                        &nbsp;<asp:LinkButton ID="lnkUnpaidReport" runat="server" CssClass="OrangeText_LeftPanel"
                            Text="View Report" OnClick="lnkUnpaidReport_Click"></asp:LinkButton>

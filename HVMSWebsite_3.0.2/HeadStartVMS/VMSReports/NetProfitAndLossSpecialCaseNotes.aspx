...
AutoEventWireup="true" CodeBehind="NetProfitAndLossSpecialCaseNotes.aspx.cs" Inherits="METAOPTION.Reports.NetProfitAndLossSpecialCaseNotes" %>

<asp:Content ID="cphNetProfitAndLossSpecialCaseNotes" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    <fieldset class="ForFieldSet">
      <legend class="ForLegend">Net Profit & Loss (Special Case Notes)</legend>
        ...
        <td colspan="4" align="center"> 
         ...
         <td class="TableBorderB">
             ...
             <td class="TableBorderB" colspan="2" style="text-align: center">
                <asp:Button ID="btnViewReportNetProfitAndLossSpecialCaseNotes"
                     runat="server" 
                     CssClass="btn" 

...
AutoEventWireup="true" CodeBehind="BlockRunListEnhanced.aspx.cs" Inherits="METAOPTION.Reports.BlockRunListEnhanced" %>

<asp:Content ID="cphBlockRunListReport" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    <fieldset class="ForFieldSet">
    <legend class="ForLegend">Block Run List Report Enhanced</legend>

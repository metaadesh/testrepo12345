...
AutoEventWireup="true" CodeBehind="RegistrationReport.aspx.cs" Inherits="METAOPTION.Reports.RegistrationReport" %>

<asp:Content ID="cphRegistrationReport" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    <fieldset class="ForFieldSet">
      <legend class="ForLegend">Registration Report</legend>
      <table border="0" cellspacing="0" cellpadding="0" width="100%" style="border-collapse: collapse">
         ...
         <tr>
            ...
            <td  colspan="2" >
                ...
                <asp:Button ID="btnViewRegistration"
                     runat="server" 
                     CssClass="btn" 

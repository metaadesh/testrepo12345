...
AutoEventWireup="true" CodeBehind="NetProfitAndLoss.aspx.cs" Inherits="METAOPTION.Reports.NetProfitAndLoss" %>

<asp:Content ID="cphNetProfitAndLoss" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    <fieldset class="ForFieldSet">
      <legend class="ForLegend">Net Profit & Loss Report</legend>
        ...
        <td colspan="4" align="center"> 
         ...
         <td class="TableBorderB">
             ...
             <td class="TableBorderB" colspan="2" style="text-align: center">
                <asp:Button ID="btnViewReportNetProfitAndLoss"
                     runat="server" 
                     CssClass="btn" 

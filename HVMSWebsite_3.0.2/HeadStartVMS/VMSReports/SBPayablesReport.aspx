...
AutoEventWireup="true" CodeBehind="SBPayablesReport.aspx.cs" Inherits="METAOPTION.Reports.SBPayablesReport" %>

<asp:Content ID="cphSBPayables" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    <fieldset class="ForFieldSet">
      <legend class="ForLegend">S. B. Payables Report</legend>
         ...
         <tr>
            ...
            <td class="TableBorder">
             ...
             <td class="TableBorderB" colspan="2" style="text-align: center">
                <asp:Button ID="btnViewReportSBPayables"
                     runat="server" 
                     CssClass="btn" 

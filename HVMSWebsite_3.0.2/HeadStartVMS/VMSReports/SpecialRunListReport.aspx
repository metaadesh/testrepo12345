...
AutoEventWireup="true" CodeBehind="SpecialRunListReport.aspx.cs" Inherits="METAOPTION.Reports.SpecialRunListReport" %>

<asp:Content ID="cphSpecialRunList" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    <fieldset class="ForFieldSet">
      <legend class="ForLegend">Special Run List Report</legend>
            ...
            <td class="TableBorder">
               <asp:UpdatePanel ID="updPnlMake" runat="server" UpdateMode="Conditional">
                ...
                <td class="TableBorderB" colspan="2" style="text-align: center">
                  <asp:Button ID="btnViewReportSpecialRunList"
                     runat="server" 
                     CssClass="btn" 

...
AutoEventWireup="true" CodeBehind="ATCAuctionsOpenDealList.aspx.cs" Inherits="METAOPTION.Reports.ATCAuctionsOpenDealList" %>

<asp:Content ID="cphATCAuctionsOpenDealListReport" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
   <fieldset class="ForFieldSet">
      <legend class="ForLegend">ATC Auctions Open Deal List Report</legend>
      <table border="0" cellspacing="0" cellpadding="0" width="100%" style="border-collapse: collapse">
       ...
       <tr>
            ...
            <td  colspan="2" >
                ...
                <asp:Button ID="btnATCAuctionsOpenDealList"
                     runat="server" 
                     CssClass="btn" 

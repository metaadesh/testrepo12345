...
CodeBehind="CommissionReport.aspx.cs" Inherits="METAOPTION.Reports.CommissionReport" %>

<asp:Content ID="cphCommission" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
   <fieldset class="ForFieldSet">
      <legend class="ForLegend">Commission Report</legend>
      <table border="0" cellspacing="0" cellpadding="0" width="100%" style="border-collapse: collapse">
         ...
         <tr>
          ...
          <td class="TableBorderB">
            ...
            <td  colspan="2" >
                     <asp:Button ID="btnViewReportCommission"
                     runat="server" 
                     CssClass="btn" 

...
<% 
    ...
    DataTable dt = ObjAnn.GetAnnouncementList_Buyer_Ver211(Convert.ToInt32(Constant.UserId));
...
%>
<a class="OrangeText_Link" title="<%=ToolTips %>" href="./AnnouncementDetails.aspx?AnnouncementId=<% =AnnouncementId%>">
    <% =StrTitle%></a>
<br>
